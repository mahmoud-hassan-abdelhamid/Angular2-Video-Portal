...
var VideoService = (function () {
    ...
    VideoService.prototype.loadVideos = function (skip) {
    ...
    VideoService.prototype.rateVideo = function (videoId, rating) {
        var currentUser = JSON.parse(localStorage.getItem('currentUser'));
        if (currentUser) {
            var sessionId = currentUser.sessionId;
    ...
    VideoService.prototype.getById = function (videoId) {
        var currentUser = JSON.parse(localStorage.getItem('currentUser'));
        if (currentUser) {
            var sessionId = currentUser.sessionId;
            var params = new http_1.URLSearchParams();
